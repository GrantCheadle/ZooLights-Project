public class method
{
  ...
  public method(String firstName, String lastName, boolean weekend, String walkOrDrive, int birth, int numHeight, int numWeight, boolean hasDiscount, String dateToday)
  {
    first = firstName;
    last = lastName;
    isWeekend= weekend;
